...
public class Moto extends Veiculo {
    ...
    public Moto(int idVeiculo, String nomeMotorista, String cpfMotorista, String telefoneMotorista, String modelo,
    ...
    public String toString() {
        return "Moto [cilindradas=" + cilindradas + ", gerarOrcamento()=" + gerarOrcamento() + ", getCilindradas()="
                + getCilindradas() + ", getIdVeiculo()=" + getIdVeiculo() + ", getNomeMotorista()=" + getNomeMotorista()
                + ", getCpfMotorista()=" + getCpfMotorista() + ", getTelefoneMotorista()=" + getTelefoneMotorista()
                + ", getModelo()=" + getModelo() + ", getPlaca()=" + getPlaca() + ", getCor()=" + getCor()
                + ", getAno()=" + getAno() + ", getDataChegada()=" + getDataChegada() + ", getMotivo()=" + getMotivo()
                + ", getClass()=" + getClass() + ", getDiagnostico()=" + getDiagnostico() + ", getTipoVeiculo()="
